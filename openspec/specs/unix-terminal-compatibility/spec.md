# Unix Terminal Compatibility Specification

## Purpose

Define the terminal-independent PTY contract, state preservation rules, qualified tmux and SSH behavior, bounded key-delivery diagnostics, and reproducible qualification evidence.
