...
| `blesh-fixture-test` | Exercise network-free empty, valid, corrupt, incomplete, symlink, and atomic-publication cache paths. | `make blesh-fixture-test`. Required on macOS and Linux; uses local synthetic archives. |
